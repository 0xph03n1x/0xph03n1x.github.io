...
My experience includes technical support, network security engineering and at present I work as a security analyst.
...
Other hobbies include playing video games like Path of Exile and World of Warcraft, going to the gym and hanging out with friends.
...
**Practical Malware Analysis and Triage (PMAT)** by [TCM Security](https://academy.tcm-sec.com/p/practical-malware-analysis-triage)  
**zero2hero (beginner malware analysis course)** by [0ffset Training Solutions](https://www.0ffset.net/beginner/)  
**Python Essentials 1 & 2** by [Python Institute](https://pythoninstitute.org/)  
**Attacking and Defending Active Director** by [Altered Security](https://www.alteredsecurity.com/)  
**Linux System Administration**  
**Cisco CCNA university courses**  
